                                    ...
                                    <div class="logo-wrapper">
                                        ...
                                        >
                                            ...
                                            <span
                                                ...
                                                >مركز المرجع الطبي</span
                                            >
                                        </h2>
                                    </div>
                                    <b-card-text class="mb-25">
                                        Hira Road - Elite beach center
                                    </b-card-text>
                                    <b-card-text class="mb-25">
                                        Jeddah, KSA
                                    </b-card-text>
            ...
            <b-col cols="12" md="4" xl="3" class="invoice-actions mt-md-0 mt-2">
                ...
                <div class="mt-2">
                    ...
                    >
                        ...
                        <b-form-checkbox id="paymentStub" switch />
                    </div>
                </div>
            </b-col>
        </b-row>
...
import InvoiceSidebarAddNewCustomer from '../apps/invoice/InvoiceSidebarAddNewCustomer.vue'
